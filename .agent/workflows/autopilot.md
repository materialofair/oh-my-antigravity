...
Combine Analyst + Architect output into `.oma/autopilot/spec.md`
...
- **ONLY** write directly to `.oma/`, `.antigravity/`, `ANTIGRAVITY.md`, `AGENTS.md`
