...
When invoked by `/oh-my-antigravity :research` skill, output these tags to communicate status:
...
### Integration with /oh-my-antigravity :research Skill

The `/oh-my-antigravity :research` skill orchestrates multi-stage research workflows. It reads these promise tags to:
