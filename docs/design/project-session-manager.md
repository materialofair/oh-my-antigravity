...
```bash
# Review PR #123 from oh-my-antigravity  repo
/psm review omc#123
...
// ~/.psm/projects.json
{
  "aliases": {
    "omc": {
      "repo": "anthropics/oh-my-antigravity ",
...
// .psm-session.json
{
  ...
  "source_repo": "~/Workspace/oh-my-antigravity ",
  "github": {
    "pr_number": 123,
    "pr_title": "Add webhook support",
    "pr_author": "contributor",
    "pr_url": "https://github.com/anthropics/oh-my-antigravity /pull/123"
  },
  "state": "active",
  "notes": []
}
...
🔍 Fetching PR #123 from oh-my-antigravity ...
